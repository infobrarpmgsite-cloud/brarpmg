...
const allImages = flats202ImageCategories.flatMap(category => 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="col-span-3 lg:col-span-1 p-5 lg:border-l lg:border-[#B4B4B4]">
                  <iframe
                    ...
                    src={`https://booking.hospitable.com/widget/${process.env.NEXT_PUBLIC_HOSPITABLE_WIDGET_ID}/${process.env.NEXT_PUBLIC_PROPERTY_FLATS_202}`}
                  />
                </div>
              </div>
            </div>
