...
const allImages = vip107ImageCategories.flatMap(category => 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                  ...
                  <div className="lg:p-4">
                    ...
                    <div className="px-4 py-5">
                      ...
                      <p className="text-sm text-gray-800 mb-6 pl-4" style={{ fontFamily: 'Segoe UI, sans-serif' }}>
                        Step into a bright 4BR/2BA sanctuary where modern style meets cozy charm—ideal for families, groups, or business travelers.
                      </p>
                ...
                <div className="col-span-3 lg:col-span-1 p-5 lg:border-l lg:border-[#B4B4B4]">
                  <iframe
                    ...
                    src={`https://booking.hospitable.com/widget/${process.env.NEXT_PUBLIC_HOSPITABLE_WIDGET_ID}/${process.env.NEXT_PUBLIC_PROPERTY_VIP_107}`}
                  />
                </div>
              </div>
            </div>
