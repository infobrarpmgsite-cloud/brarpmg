    ...
    <footer className="bg-brand-primary text-brand-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">BRAR PMG</h3>
            <p className="text-brand-lightGray mb-4">
              Professional property management services tailored to your needs. 
              We provide comprehensive solutions for property owners and tenants.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="text-brand-lightGray space-y-2">
              <p>Email: info@brarproperty.com</p>
        ...
        <div className="border-t border-brand-darkGray mt-8 pt-8 text-center">
          <p className="text-brand-lightGray">
            © {new Date().getFullYear()} BRAR PMG. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
